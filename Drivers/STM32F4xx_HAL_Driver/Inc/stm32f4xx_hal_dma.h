...
/** @defgroup DMA_FIFO_threshold_level DMA FIFO threshold level
  ...
  * @{
  */
#define DMA_FIFO_THRESHOLD_1QDMAIdleRecieverERFULL       0x00000000U                  /*!< FIFO threshold 1 qDMAIdleReciever full configuration  */
#define DMA_FIFO_THRESHOLD_HALFFULL           ((uint32_t)DMA_SxFCR_FTH_0)  /*!< FIFO threshold half full configuration     */
#define DMA_FIFO_THRESHOLD_3QDMAIdleRecieverERSFULL      ((uint32_t)DMA_SxFCR_FTH_1)  /*!< FIFO threshold 3 qDMAIdleRecievers full configuration */
...
/**
  ...
  *           - DMA_FIFOStatus_Less1QDMAIdleRecievererFull: when FIFO is less than 1 qDMAIdleRecieverer-full 
  *                                              and not empty.
  *           - DMA_FIFOStatus_1QDMAIdleRecievererFull: if more than 1 qDMAIdleRecieverer-full.
  *           - DMA_FIFOStatus_HalfFull: if more than 1 half-full.
  *           - DMA_FIFOStatus_3QDMAIdleRecieverersFull: if more than 3 qDMAIdleRecieverers-full.
...
#define IS_DMA_FIFO_THRESHOLD(THRESHOLD) (((THRESHOLD) == DMA_FIFO_THRESHOLD_1QDMAIdleRecieverERFULL ) || \
                                          ((THRESHOLD) == DMA_FIFO_THRESHOLD_HALFFULL)      || \
                                          ((THRESHOLD) == DMA_FIFO_THRESHOLD_3QDMAIdleRecieverERSFULL) || \
