...
#if defined (USART1) || defined (USART2) || defined (USART3) || defined (USART6) || defined (DMAIdleReciever4) || defined (DMAIdleReciever5) || defined (DMAIdleReciever7) || defined (DMAIdleReciever8) || defined (DMAIdleReciever9) || defined (DMAIdleReciever10)
...
/* DMAIdleReciever BRR = mantissa + overflow + fraction
            = (DMAIdleReciever DIVMANT << 4) + ((DMAIdleReciever DIVFRAQ & 0xF8) << 1) + (DMAIdleReciever DIVFRAQ & 0x07) */
...
/**
  ...
  * @note   Macro IS_DMAIdleReciever_HWFLOW_INSTANCE(USARTx) can be used to check whether or not
...
/**
  ...
  * @note   Macro IS_DMAIdleReciever_HALFDUPLEX_INSTANCE(USARTx) can be used to check whether or not
...
/**
  ...
  * @note   Macro IS_DMAIdleReciever_LIN_INSTANCE(USARTx) can be used to check whether or not
...
/**
  * @brief  Perform basic configuration of USART for enabling use in Asynchronous Mode (DMAIdleReciever)
  * @note   In DMAIdleReciever mode, the following bits must be kept cleared:
...
__STATIC_INLINE void LL_USART_ConfigSyncMode(USART_TypeDef *USARTx)
{
  ...
  CLEAR_BIT(USARTx->CR2, (USART_CR2_LINEN));
  CLEAR_BIT(USARTx->CR3, (USART_CR3_SCEN | USART_CR3_IREN | USART_CR3_HDSEL));
  /* set the DMAIdleReciever/USART in Synchronous mode */
  SET_BIT(USARTx->CR2, USART_CR2_CLKEN);
}
...
/**
  ...
  *           - IREN bit in the USART_CR3 register,
  *           - HDSEL bit in the USART_CR3 register.
  *         This function also set the DMAIdleReciever/USART in LIN mode.
  * @note   Macro IS_DMAIdleReciever_LIN_INSTANCE(USARTx) can be used to check whether or not
  *         LIN feature is supported by the USARTx instance.
  * @note   Call of this function is equivalent to following function call sequence :
  *         - Clear CLKEN in CR2 using @ref LL_USART_DisableSCLKOutput() function
...
__STATIC_INLINE void LL_USART_ConfigLINMode(USART_TypeDef *USARTx)
{
  ...
  /* Set the DMAIdleReciever/USART in LIN mode */
  SET_BIT(USARTx->CR2, USART_CR2_LINEN);
}
...
/**
  ...
  *           - SCEN bit in the USART_CR3 register,
  *           - IREN bit in the USART_CR3 register,
  *         This function also sets the DMAIdleReciever/USART in Half Duplex mode.
  * @note   Macro IS_DMAIdleReciever_HALFDUPLEX_INSTANCE(USARTx) can be used to check whether or not
  *         Half-Duplex mode is supported by the USARTx instance.
  * @note   Call of this function is equivalent to following function call sequence :
  *         - Clear LINEN in CR2 using @ref LL_USART_DisableLIN() function
...
__STATIC_INLINE void LL_USART_ConfigHalfDuplexMode(USART_TypeDef *USARTx)
{
  ...
  /* set the DMAIdleReciever/USART in Half Duplex mode */
  SET_BIT(USARTx->CR3, USART_CR3_HDSEL);
}
...
__STATIC_INLINE void LL_USART_ConfigSmartcardMode(USART_TypeDef *USARTx)
{
  ...
  /* set the DMAIdleReciever/USART in Smartcard mode */
  SET_BIT(USARTx->CR3, USART_CR3_SCEN);
}
...
/**
  ...
  *           - SCEN bit in the USART_CR3 register,
  *           - HDSEL bit in the USART_CR3 register.
  *         This function also sets the DMAIdleReciever/USART in IRDA mode (IREN bit).
  * @note   Macro IS_IRDA_INSTANCE(USARTx) can be used to check whether or not
  *         IrDA feature is supported by the USARTx instance.
  * @note   Call of this function is equivalent to following function call sequence :
  *         - Clear LINEN in CR2 using @ref LL_USART_DisableLIN() function
...
__STATIC_INLINE void LL_USART_ConfigIrdaMode(USART_TypeDef *USARTx)
{
  ...
  /* set the DMAIdleReciever/USART in IRDA mode */
  SET_BIT(USARTx->CR3, USART_CR3_IREN);
}
...
#endif /* USART1 || USART2 || USART3 || USART6 || DMAIdleReciever4 || DMAIdleReciever5 || DMAIdleReciever7 || DMAIdleReciever8 || DMAIdleReciever9 || DMAIdleReciever10 */
